...
<div class="container-fluid m-0 p-0">
    <div class="container w-50 float-left">
        ...
        <a style="font-size: 1.2rem;" title="Overall score based on the other skills. Of all, this is the one that best represents the player's skill">General Skill: </a>
        ...
        <a title="Accuracy represents how often your plays result in a goal or assist."
        >Accuracy: <?php echo number_format(($OVR_Stats[8] * 100 ), 0).'%'; ?> </a>
        <a><?php 
            if ($OVR_Stats[8] > 0.55) 
                echo '(Good)';
        ...
        <a style="font-size: 1.2rem;">Arquetypes:</a><br>
    ...
    <div class="w-50 float-right">
        <a style="font-size: 1.2rem;">Your main play style is: <b><?= $PlayStyle ?></b></a>
    </div>
...
<script type="text/javascript">
    ...
    var myChart = new Chart(ctx, {
        type: 'radar',
        data: {
            labels: ['Shoot', 'Pass', 'Pression', 'Defense', 'Drible', 'Aerial'],
            datasets: [{
                label: 'Score',
                data: data,
                borderWidth: 1,
